# Revisar Si funciona pero no lo hice yo
...
def get_pdf_file_content(path_to_pdf):
    ...
    '''
    for page in PDFPage.get_pages(fp, pagenos=set(), maxpages=8, password="", caching=True, check_extractable=True):
...
path_to_pdf = "D:\Proyectos\Python Pr\Practicas\dist\Aprenda-a-pensar-como-un-programador-con-python(1).pdf"
